...
<template>
    <footer class="app-footer full">
        ...
        <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="176" height="52">
        ...
        <section class="footer-content">
            <div class="footer-info">
                ...
                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil accusantium quisquam quos cupiditate,
                    vitae perferendis id fugiat, voluptates deserunt ipsam dolore, consequatur repellat ex maiores possimus
                    neque animi ullam fugit.</span>
            </div>
            <div>
