...
<template>
    ...
    <section class="teaser-list">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="83" height="78">
                <g fill="none" fill-rule="evenodd">
                    ...
                    <g transform="translate(55.377 23.07)" stroke="#62E0D9">
                        <rect stroke-width="1.641" fill="#181F2B" x=".821" y=".821" width="25.621" height="52.795"
                            rx="2.462" />
        ...
        <h3>Access you files, anywhere</h3>
    ...
    <article class="teaser">
        <svg xmlns="http://www.w3.org/2000/svg" width="91" height="64">
            <g fill="none" fill-rule="evenodd">
                ...
                <path d="M30.01 37.805h12.523m-12.524 3.841h11.272m-11.272 3.842h7.514" stroke="#FFF"
                    stroke-width=".803" stroke-linecap="round" stroke-linejoin="round" />
                <g>
                    <path
